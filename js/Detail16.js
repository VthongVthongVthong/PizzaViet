document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addToCartButton && quantityInput) {
        addToCartButton.addEventListener('click', function(event) {
            ...
            let cart = JSON.parse(localStorage.getItem('detail16')) || [];
            ...
            localStorage.setItem('detail16', JSON.stringify(cart));
    ...
    if (localStorage.getItem('detail166')) {
        if (noProductDiv) {
            noProductDiv.style.display = 'none';
        }

        const cart = JSON.parse(localStorage.getItem('detail166'));
        ...
        cart.forEach((product, index) => {
            ...
            function updateProductQuantity(index, quantity) {
                ...
                localStorage.setItem('detail166', JSON.stringify(cart));
