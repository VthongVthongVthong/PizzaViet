document.addEventListener('DOMContentLoaded', () => {
    ...
    if (addToCartButton && quantityInput) {
        addToCartButton.addEventListener('click', function(event) {
            ...
            const quantity = parseInt(quantityInput.value);
            const unitPrice = 195000; // Giá tiền cố định cho sản phẩm
            ...
            let cart = JSON.parse(localStorage.getItem('detail3')) || [];
            ...
            localStorage.setItem('detail3', JSON.stringify(cart));
    ...
    if (localStorage.getItem('detail3')) {
        ...
        const cart = JSON.parse(localStorage.getItem('detail3'));
